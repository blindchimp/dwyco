...
#include $(MY_CONF_LOCAL_PATH)/lpc/Android.mk
...
#include $(MY_CONF_LOCAL_PATH)/ext-android.mk
...
#include $(MY_CONF_LOCAL_PATH)/libspeex/Android2.mk

include $(CLEAR_VARS)
LOCAL_MODULE := dwyco_jni
LOCAL_PATH := $(call my-dir)

LOCAL_WHOLE_STATIC_LIBRARIES := jhead cdc32 gsm lpc ppm pgm pbm vc crypto5 zlib kazlib jenkins dwcls
