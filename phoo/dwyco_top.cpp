...
#ifdef MACOS_EMOJI_CRASH_HACK
static QString replaceEmoji(const QString &txt)
{
    static const std::unordered_map<uint32_t, QString> emap = {
        // Smileys and emotions
        {0x1F600, QStringLiteral(":D")},
        {0x1F601, QStringLiteral(":D")},
        {0x1F602, QStringLiteral(":'-)")},
        {0x1F603, QStringLiteral(":D")},
        {0x1F604, QStringLiteral(":D")},
        {0x1F605, QStringLiteral("xD")},
        {0x1F606, QStringLiteral("xD")},
        {0x1F607, QStringLiteral("O:-)")},
        {0x1F608, QStringLiteral("}:-)")},
        {0x1F609, QStringLiteral(";-)")},
        {0x1F60A, QStringLiteral(":-)")},
        {0x1F60B, QStringLiteral("yummy")},
        {0x1F60C, QStringLiteral(":)")},
        {0x1F60D, QStringLiteral("<3")},
        {0x1F60E, QStringLiteral("B-)")},
        {0x1F60F, QStringLiteral(":-/")},
        {0x1F610, QStringLiteral(":-|")},
        {0x1F611, QStringLiteral("-_-")},
        {0x1F612, QStringLiteral(":-/")},
        {0x1F613, QStringLiteral("sweat")},
        {0x1F614, QStringLiteral(":-(")},
        {0x1F615, QStringLiteral(":-/")},
        {0x1F616, QStringLiteral(":-S")},
        {0x1F617, QStringLiteral(":-*")},
        {0x1F618, QStringLiteral(":-*")},
        {0x1F619, QStringLiteral(":*")},
        {0x1F61A, QStringLiteral(":*")},
        {0x1F61B, QStringLiteral(";-P")},
        {0x1F61C, QStringLiteral(";P")},
        {0x1F61D, QStringLiteral(":-P")},
        {0x1F61E, QStringLiteral(":-(")},
        {0x1F61F, QStringLiteral(":-(")},
        {0x1F620, QStringLiteral(">:(")},
        {0x1F621, QStringLiteral(">:(")},
        {0x1F622, QStringLiteral(":'(")},
        {0x1F623, QStringLiteral(":'(")},
        {0x1F624, QStringLiteral(">:(")},
        {0x1F625, QStringLiteral(":'(")},
        {0x1F626, QStringLiteral(":O")},
        {0x1F627, QStringLiteral(":O")},
        {0x1F628, QStringLiteral("scared")},
        {0x1F629, QStringLiteral("tired")},
        {0x1F62A, QStringLiteral("sleepy")},
        {0x1F62B, QStringLiteral("tired")},
        {0x1F62C, QStringLiteral(":O")},
        {0x1F62D, QStringLiteral(":'(")},
        {0x1F62E, QStringLiteral(":O")},
        {0x1F62F, QStringLiteral("hushed")},
        {0x1F630, QStringLiteral("scared")},
        {0x1F631, QStringLiteral("scream")},
        {0x1F632, QStringLiteral("astonished")},
        {0x1F633, QStringLiteral("blush")},
        {0x1F634, QStringLiteral("zzz")},
        {0x1F635, QStringLiteral("dizzy")},
        {0x1F636, QStringLiteral(":-|")},
        {0x1F637, QStringLiteral("mask")},
        {0x1F644, QStringLiteral("rolling")},
        {0x1F910, QStringLiteral("zip")},
        {0x1F911, QStringLiteral("money")},
        {0x1F912, QStringLiteral("sick")},
        {0x1F913, QStringLiteral("nerd")},
        {0x1F914, QStringLiteral("hmm")},
        {0x1F915, QStringLiteral("bandage")},
        {0x1F923, QStringLiteral(":'-)")},
        {0x1F92A, QStringLiteral(">:(")},
        {0x1F92B, QStringLiteral("shush")},
        {0x1F92C, QStringLiteral("wow")},
        {0x1F92D, QStringLiteral(":-*")},
        {0x1F92E, QStringLiteral(":-(")},
        {0x1F92F, QStringLiteral(">_<")},
        {0x1F970, QStringLiteral("<3")},
        {0x1F973, QStringLiteral("party")},
        {0x1F974, QStringLiteral(":-(")},
        {0x1F975, QStringLiteral("hot")},
        {0x1F976, QStringLiteral("cold")},
        // Hearts
        {0x2764,  QStringLiteral("<3")},
        {0x1F9E1, QStringLiteral("<3")},
        {0x1F49B, QStringLiteral("<3")},
        {0x1F49A, QStringLiteral("<3")},
        {0x1F499, QStringLiteral("<3")},
        {0x1F49C, QStringLiteral("<3")},
        {0x1F5A4, QStringLiteral("<3")},
        {0x1F90D, QStringLiteral("<3")},
        {0x1F90E, QStringLiteral("<3")},
        {0x1F493, QStringLiteral("<3")},
        {0x1F494, QStringLiteral("</3")},
        {0x1F495, QStringLiteral("<3")},
        {0x1F496, QStringLiteral("<3")},
        {0x1F497, QStringLiteral("<3")},
        {0x1F498, QStringLiteral("<3")},
        {0x1F49D, QStringLiteral("<3")},
        {0x1F49E, QStringLiteral("<3")},
        {0x1F49F, QStringLiteral("<3")},
        {0x2763,  QStringLiteral("<3")},
        // Hand gestures
        {0x1F44D, QStringLiteral("(y)")},
        {0x1F44E, QStringLiteral("(n)")},
        {0x1F44B, QStringLiteral("(wave)")},
        {0x1F44A, QStringLiteral("fist")},
        {0x1F44F, QStringLiteral("clap")},
        {0x1F44C, QStringLiteral("OK")},
        {0x270A,  QStringLiteral("fist")},
        {0x270B,  QStringLiteral("hand")},
        {0x270C,  QStringLiteral("V")},
        {0x1F91E, QStringLiteral("fingers")},
        {0x1F91F, QStringLiteral("rock")},
        {0x1F918, QStringLiteral("rock")},
        {0x1F919, QStringLiteral("call")},
        {0x1F91A, QStringLiteral("fist")},
        {0x1F91B, QStringLiteral("fist")},
        {0x1F590, QStringLiteral("hand")},
        {0x1F596, QStringLiteral("spock")},
        {0x1F64C, QStringLiteral("raise")},
        {0x1F64F, QStringLiteral("pray")},
        {0x1F64B, QStringLiteral("raise")},
        // Common symbols
        {0x1F525, QStringLiteral("fire")},
        {0x1F4A2, QStringLiteral("angry")},
        {0x1F4A5, QStringLiteral("boom")},
        {0x1F4A6, QStringLiteral("sweat")},
        {0x1F4A8, QStringLiteral("dash")},
        {0x1F4A9, QStringLiteral("poo")},
        {0x1F4AA, QStringLiteral("muscle")},
        {0x1F4AB, QStringLiteral("dizzy")},
        {0x1F4AC, QStringLiteral("speech")},
        {0x1F4AD, QStringLiteral("thought")},
        {0x2728,  QStringLiteral("*star*")},
        {0x2B50,  QStringLiteral("star")},
        {0x1F4AF, QStringLiteral("100")},
        {0x1F4B0, QStringLiteral("money")},
        {0x1F451, QStringLiteral("crown")},
        {0x1F4A1, QStringLiteral("idea")},
        {0x1F4F1, QStringLiteral("phone")},
        {0x260E,  QStringLiteral("phone")},
        {0x1F4F7, QStringLiteral("camera")},
        {0x1F4F8, QStringLiteral("camera")},
        {0x1F4BB, QStringLiteral("laptop")},
        {0x1F4FA, QStringLiteral("tv")},
        {0x2600,  QStringLiteral("sun")},
        {0x2601,  QStringLiteral("cloud")},
        {0x2614,  QStringLiteral("rain")},
        {0x26A1,  QStringLiteral("lightning")},
        {0x2744,  QStringLiteral("snow")},
        {0x1F31F, QStringLiteral("star")},
        {0x1F308, QStringLiteral("rainbow")},
        {0x2708,  QStringLiteral("plane")},
        {0x1F680, QStringLiteral("rocket")},
        // Common objects
        {0x2615,  QStringLiteral("coffee")},
        {0x1F37B, QStringLiteral("beer")},
        {0x1F37A, QStringLiteral("beer")},
        {0x1F377, QStringLiteral("wine")},
        {0x1F354, QStringLiteral("burger")},
        {0x1F355, QStringLiteral("pizza")},
        {0x1F382, QStringLiteral("cake")},
        {0x1F381, QStringLiteral("gift")},
        {0x1F389, QStringLiteral("party")},
        {0x1F3C6, QStringLiteral("trophy")},
        {0x1F3B5, QStringLiteral("music")},
        {0x1F3B6, QStringLiteral("music")},
        {0x1F3AE, QStringLiteral("game")},
        {0x1F3B0, QStringLiteral("dice")},
        {0x1F339, QStringLiteral("rose")},
        {0x1F33B, QStringLiteral("sunflower")},
        {0x1F340, QStringLiteral("clover")},
        {0x1F431, QStringLiteral("cat")},
        {0x1F436, QStringLiteral("dog")},
        {0x1F43B, QStringLiteral("bear")},
        {0x1F435, QStringLiteral("monkey")},
        {0x1F697, QStringLiteral("car")},
        {0x1F6B2, QStringLiteral("bike")},
        {0x1F3E0, QStringLiteral("house")},
        {0x1F3EB, QStringLiteral("school")},
        {0x1F3E5, QStringLiteral("hospital")},
        {0x1F3C1, QStringLiteral("flag")},
    };

    QString out;
    out.reserve(txt.size());
    for (int i = 0; i < txt.size(); ) {
        uint cp = txt[i].unicode();
        int inc = 1;
        if (QChar::isHighSurrogate(cp) && i + 1 < txt.size()) {
            cp = QChar::surrogateToUcs4(cp, txt[i + 1].unicode());
            inc = 2;
        } else if (QChar::isLowSurrogate(cp)) {
            i += 1;
            continue;
        }
        auto it = emap.find(cp);
        if (it != emap.end()) {
            out += it->second;
        } else if (cp >= 0x1F300 && cp <= 0x1F9FF) {
            out += QStringLiteral("[U+%1]").arg(cp, 4, 16, QChar('0'));
        } else if ((cp >= 0x2600 && cp <= 0x27BF) ||
                   (cp >= 0x2300 && cp <= 0x23FF)) {
            out += QStringLiteral("[U+%1]").arg(cp, 4, 16, QChar('0'));
        } else if ((cp >= 0xFE00 && cp <= 0xFE0F) || cp == 0x200D) {
