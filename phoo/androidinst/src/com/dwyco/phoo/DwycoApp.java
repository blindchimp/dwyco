...
public class DwycoApp {
	...
	public static String lock_shared_prefs = "com.dwyco.phoo.prefs";
	// name of shared preferences
	public static String shared_prefs = "phoo";
	// notification message to use when a msg has been downloaded in the
	// background and is available immediately
	public static String new_received = "New msg received";
	// notification message used for fcm notification that msg is available
	public static String new_available = "New message";
	// title used on all notifications
	public static String content_title = "Dwyco Phoo";
	...
	public static boolean sender_sticky = true;
