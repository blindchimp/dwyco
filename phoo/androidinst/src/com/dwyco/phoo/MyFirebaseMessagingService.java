    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            if(v != null)
            {
                ...
                // if the user has launched the app since the
                // notification was generated, just assume they
                // saw everything up to then. this filters out a lot of
                // the late notifications we get from FCM
