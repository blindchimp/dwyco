...
# NOTE: hacked by me to set the NDK to 28.2 so it builds by default with 16kb alignment
# this was hacked from what was from KDAB (i think?) and it works if android_openssl is
# put into ~/Android/Sdk
