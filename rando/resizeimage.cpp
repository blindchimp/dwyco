...
static
void
save_random_filename(const QBuffer& img, QByteArray& out_fn)
{
    QByteArray tmp_fn = random_fn();
    tmp_fn += ".jpg";
...
int
load_and_resize(const QByteArray &filename, QByteArray& out_fn, int maxsize)
{
    out_fn = "";
    try
    {
