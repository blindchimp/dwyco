 ...
 * mind this extra definition and initialization, and it
 * appears to work ok.
 * the ms compilers complain about the multiple definition,
 * and if you want to change to default O_BINARY, you need to
...
#ifdef MSDOS
	/* make sure stdin and stdout are in binary mode */
	setmode(0, O_BINARY);
	setmode(1, O_BINARY);
#endif
