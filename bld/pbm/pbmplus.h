...
*/
#if defined(BSD) || defined(MACOSX) || defined(LINUX) || defined(DWYCO_IOS)
#include <stdlib.h>
#elif (defined(SYSV) && !defined(VMS))
#include <malloc.h>
#else
#include <stdlib.h>
#endif
...
#if defined(__STDC__) || defined(__BORLANDC__) || defined(_MSC_VER) || defined(ANDROID) || defined(LINUX)
#define USE_PROTOTYPES
#define KINDA_STDC
#endif

#if defined(__BORLANDC__) || defined(_MSC_VER) || defined(ANDROID) || defined(LINUX)
