...
class VcIOHack {
    VcIOHack(const VcIOHack&) = delete;
    VcIOHack& operator=(const VcIOHack&) = delete;
private:
	FILE *sio;
protected:
	const char *format;
...
class VcIOHackStr : public VcIOHack {
    VcIOHackStr(const VcIOHackStr&) = delete;
    VcIOHackStr& operator=(const VcIOHackStr&) = delete;
private:
	DwGrowingString s;
public:
	VcIOHackStr(int = 128);
