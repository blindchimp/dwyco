...
/*
 * $Header: g:/dwight/repo/cdc32/rcs/jpeglib.h 1.7 1997/11/25 20:41:03 dwight Stable095 $
 */
/*
 * jpeglib.h
 *
...
struct jpeg_compress_struct {
  ...
  int interleave;		/* TRUE=interleaved output, FALSE=not */
...
struct jpeg_source_mgr {
  ...
  JMETHOD(int, resync_to_restart, (j_decompress_ptr cinfo));
...
EXTERN void jpeg_set_quality JPP((int quality,
				  int force_baseline));
EXTERN void jpeg_set_linear_quality JPP((
					 int scale_factor,
					 int force_baseline));
EXTERN void jpeg_add_quant_table JPP((int which_tbl,
